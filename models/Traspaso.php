 ...
 */
class Traspaso extends CActiveRecord
{
    public $fechaDesde;
    public $fechaHasta;
    ...
    public function rules()
    {
            ...
            return array(
                    ...
                    array('id, numero, fecha, estado, tipo, cliente, almacen, idalmacen, usuario, idpedido,'
                        . ' eliminado, numeropedido, total, idmoneda,fechaDesde,fechaHasta', 'safe', 'on'=>'search'),
            );
    }
     ...
     * @return Traspaso the static model class
     */
