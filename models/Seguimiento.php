 ...
 * @property Comunicacion $idcomunicacion0
 */
class Seguimiento extends CActiveRecord
{
    ...
    public function rules()
    {
            ...
            return array(
                    array('idtabla, idcomunicacion', 'numerical', 'integerOnly'=>true),
                    array('usuario', 'length', 'max'=>30),
                    array('tabla', 'length', 'max'=>20),
                    array('descripcion, eliminado, fecha', 'safe'),
                    // The following rule is used by search().
                    // @todo Please remove those attributes that should not be searched.
                    array('descripcion, eliminado, usuario, fecha, tabla, idtabla, idcomunicacion, id', 'safe', 'on'=>'search'),
            );
    }
    ...
    public function relations()
    {
            ...
            return array(
                    'idcomunicacion0' => array(self::BELONGS_TO, 'Comunicacion', 'idcomunicacion'),
            );
    }
    ...
    public function beforeSave() {
		...
		if($this->scenario!='WS.Registar')$this->usuario= Yii::app()->user->getName();
		if ($this->isNewRecord) $this->fecha= new CDbExpression('NOW()');
