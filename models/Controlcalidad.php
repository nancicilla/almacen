...
Identificador de documento',
    ...
    public function afterFind(){
       $this->finalizado=$this->idestado==Estado::FINALIZADO;
       $this->usuariofinalizado=Yii::app()->user->getName();
//       if($this->finalizado==true)echo 'SI';
//       if($this->finalizado==false)echo 'NO'.$this->id.'[]';
    }
}
