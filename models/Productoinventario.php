 ...
 * Creacion: 17/03/2015
 *
 * Ultima Actualizacion: $Date: 2020-05-08 17:20:54 -0400 (vie, 08 may 2020) $:
 * 
...
class Productoinventario extends CActiveRecord {
    ...
    public function actualizarSaldo($pidproducto, $pidinventario, $psaldo) {
        $command = Yii::app()->almacen->createCommand
                ('select "'.getGestionSchema().'".productoinventario_actualizar_saldo(:pidproducto,:pidinventario,:psaldo)');
