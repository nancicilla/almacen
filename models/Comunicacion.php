 ...
 *
 * The followings are the available columns in table 'comunicacion':
 * @property integer $id
...
class Comunicacion extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('nombre', 'unique', 'on' => array('insert', 'update'), 'message' => 'El nombre ya existe'),
            array('nombre', 'length', 'max' => 50),
            array('usuario', 'length', 'max' => 30),
            array('eliminado, fecha', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, nombre, eliminado, usuario, fecha', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'seguimientos' => array(self::HAS_MANY, 'Seguimiento', 'idcomunicacion'),
        );
    }
