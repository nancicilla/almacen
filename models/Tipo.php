 ...
 * @property Notaborrador[] $notaborradors
 * @property Nota[] $notas
 */
class Tipo extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('nombre, fecha', 'required', 'on' => array('insert', 'update')),
            array('nombre, usuario', 'length', 'max' => 30),
            array('eliminado,ingreso', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, nombre, fecha, eliminado, usuario,ingreso', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'motivos' => array(self::HAS_MANY, 'Motivo', 'idtipo'),
            'causas' => array(self::HAS_MANY, 'Causa', 'idtipo'),
            'notaborradors' => array(self::HAS_MANY, 'Notaborrador', 'idtipo'),
            'notas' => array(self::HAS_MANY, 'Nota', 'idtipo'),
        );
    }
