...
class Controlseguimiento extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, comunicacion,producto, descripcion, numero, tabla, idtabla, fecha, usuario', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search() {
        ...
        if ($this->producto != Null) {
            $criteria->addCondition("t.producto ilike '%" . $this->producto . "%'");
        }
        ...
        Yii::app()->session['reporteSeguimiento2'] = $criteria;
