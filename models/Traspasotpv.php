...
class Traspasotpv extends CActiveRecord
{
    ...
    public function rules()
    {
            ...
            return array(
                    ...
                    array('glosa, fecha, eliminado, descripcionenvio', 'safe'),
                    // The following rule is used by search().
                    // @todo Please remove those attributes that should not be searched.
                    array('id, numero,fechaDesde,fechaHasta, glosa, idestado,idproducto, idalmacenorigen, idalmacendestino, usuario, fecha, eliminado, idalmacen,descripcionenvio', 'safe', 'on'=>'search'),
            );
    }
    ...
    public function attributeLabels()
    {
            ...
            'eliminado' => 'Eliminado',
            'idalmacen' => 'Idalmacen',
            'descripcionenvio' => 'Descripcion de Envio',
            );
    }
...
//                    $gestion=  System::getGestionSchema();
    ...
    */
    ...
    {
        $criteria = new CDbCriteria;
        $criteria->select = 'tp.id,tp.idproducto,p.coduniversal,p.codigo,p.nombre ,u.simbolo as idunidad,u.permitirdecimal,'
                          . ' p.saldo, p.reserva, tp.cantidadsolicitada, tp.cantidadenviada, tp.cantidadrecibida,1 as solicitud,true as conforme';
        $criteria->join = 'inner join "'.getGestionSchema().'".traspasoproducto tp on t.id = tp.idtraspaso and tp.eliminado = false
    ...
    public function cantproducto($idproducto){
        ...
        //return 55.00;
        $gestion=  System::getGestionSchema();
        $q="select cantidadenviada from traspasoproducto where idproducto=$idproducto and idtraspaso=$this->id and eliminado=false;";
        
        $command = Yii::app()->tpv->createCommand($q);
        $fila=$command->queryRow();
        $cantidad=$fila['cantidadenviada'];
