 ...
 * Creacion: 17/03/2015
 *
 * Ultima Actualizacion: $Date: 2019-09-28 11:40:00 -0400 (sáb, 28 sep 2019) $:
 * 
...
class Estado extends CActiveRecord {
    ...
    const ESTADO_ENTREGA = 26;
    const ESTADO_ESPERA = 24;
    const ESTADO_PENDIENTERECEPCION = 31;
    const ESTADO_RECEPCIONADO = 32;
    const ESTADO_PENDIENTECC = 29;
    const ESTADO_FINALIZADOCC = 30;
    const ESTADO_SINVERIFICAR =33;
    const ESTADO_CORRECCION =34;
    const ESTADO_PENDIENTE = 26; // estado de venta
