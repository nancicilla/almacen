...
class ProveedorController extends Controller
{
         ...
         public function actionBuscarProveedor()
    {
        ...
        $datos = Proveedor::model()->filtraProveedor($_POST['nombre']);
        if(count($datos->getData()) == 0)
            $datos = array(
                0 => array('nombre' => $_POST['nombre'], 'id' => '0')
            );
        
        echo SGridView::widget('TGridViewList', array(
            'dataProvider' => $datos,
            'columns' => array(
                array('name' => 'nombre', 'header' => 'Proveedor', 'value' => '$data->nombre'),
                array('name' => 'id', 'typeCol' => 'hidden', 'value' => '$data->id'),
            ),
        ));
    }
}
