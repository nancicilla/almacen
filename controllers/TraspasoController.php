...
class TraspasoController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if(isset($_POST['Traspaso'])){
                $model->attributes=$_POST['Traspaso'];
                if($model->save()){                       
    ...
    public function actionAdmin()
    {
        ...
        if(isset($_GET['Traspaso'])){
                $model->attributes=$_GET['Traspaso'];
                if (!$model->validate()) {
	...
	{
		$model=Traspaso::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Traspaso $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='traspaso-form')
		{
