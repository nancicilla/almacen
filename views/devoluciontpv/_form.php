    ...
    <div class="formWindow">
        <div style="left:570px; cursor:pointer;  top:35px; width:260px; height:23px; padding:2px; padding-top: 0px;   position: absolute; ">
            ...
            <div class="column">
                ...
                echo $form->hiddenField($model, 'idalmacen', array('value' => $modelPuntoVenta->idalmacen));
                echo $form->hiddenField($model, 'idalmacenorigen', array('value' => $modelPuntoVenta->idalmacen));
                ?>
            </div>
            <div class="column">
                <?php
                        ...
                        $model, 'idalmacendestino', CHtml::listData(Almacen::model()
                                        ->findAll(
                                                array(
                                                    ...
                                                    $modelPuntoVenta->idalmacen)), 'id', 'nombre'), array(
        ...
        echo System::widgetTabs(array(
            ...
            'tabs' => array(
                'Productos' => array('id' => 'producto',
                    'content' => $this->renderPartial('_producto', array('model' => $model, 'form'=> $form, 'gridDevolucionproducto' => $gridDevolucionproducto), true),
                    'titleWidth' => 130,
                ),
            ),
        ));
