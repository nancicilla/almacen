    ...
    <div class="formWindow">
        <div class="row">
            ...
            <div class="column">
                ...
                echo $form->dropDownList(
                    ...
                    array('empty' => '', 'style' => 'width: 100px;')
                );
                ?>
            </div>
            <div class="column">               
                <?php echo $form->label($model, 'lineatabu'); ?>
                <?php echo $form->checkBox($model, 'lineatabu'); ?>  
            </div>
            <div class="column">
                <?php echo $form->label($model, 'admitedescuento'); ?>
                <?php echo $form->checkBox($model, 'admitedescuento'); ?>
            </div>
        </div>
        <div class="row">
            <div class="column">
            ...
            <div class="column">
                ...
                <?php echo $form->textField($model, 'nombre', array('maxlength' => 100, 'style' => 'width:380px;', 'readonly' => 'true')); ?>
            </div>           
            <?php echo $form->hiddenField($model, 'existeImagen'); ?>
            <div class="column">
                <?php echo $form->labelEx($model, 'nombresenasag'); ?>
                <?php echo $form->textField($model, 'nombresenasag', array('maxlength' => 100, 'style' => 'text-transform: uppercase;width:170px;')); ?>
            </div>
            <div class="column">
            ...
            <div class="column">
                ...
                <?php echo $form->textField($model, 'precio',array('style' => 'width:100px;')); ?>
            </div>
            <div class="column">
                <?php echo $form->labelEx($model, 'ultimoppp'); ?>
                <?php echo $form->textField($model, 'ultimoppp',array('disabled' => !$model->isNewRecord,'class' => 'numeric', 'maxlength' => 13, 'style' => 'width:80px;')); ?>
            </div>
            <div class="column">
                <?php echo $form->label($model, 'ventatpv'); ?>
                <?php echo $form->checkBox($model, 'ventatpv'); ?>
            </div>
        </div>
        ...
        echo System::widgetTabs(array(
            ...
            'tabs' => array(
                ...
                'Requisito' => array('id' => 'plantillaExtra',
                    'content' => $this->renderPartial('_requisito', array('form' => $form, 'model' => $model, 'gridRequisito' => $gridRequisito), true),
                    'titleWidth' => 120,
                ),
            ),
        ));
