...
?>
	...
	<div class="row">
        ...
        ?>
    <div class="row" <?php echo 'id="' . System::Id('modoFactura') . '"'; ?>>
        <div class="column"  style="position: absolute; left: 20px; top: 480px;">
            <?php
            echo $form->labelEx($model, 'descripcionenvio');
            ?>
        </div>
        <div class="column" style="position: absolute; left: 150px; top: 480px;">
            <?php
            echo $form->textArea($model, 'descripcionenvio', array(
                'style' => 'float:left;background:#fffd96;width:100px;height:20px; text-transform: uppercase;',
                'rows' => 1,
                'cols' => 1,
