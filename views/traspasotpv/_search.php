		...
		<?php echo $form->label($model,'idestado'); ?>
                <?php echo $form->dropDownList($model, 'idestado', CHtml::listData(
                        Estadotpv::model()->findAll(
                                array('order' => 'nombre','condition'=>'t.eliminado = false and t.id in ('.Estadotpv::SOLICITUD.','.Estadotpv::BORRADOR.','.Estadotpv::TRASPASO.','.Estadotpv::FINALIZADO.','.Estadotpv::ANULADO.','.Estadotpv::RESERVA.')')
