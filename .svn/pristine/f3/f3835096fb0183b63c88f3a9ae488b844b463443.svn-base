 ...
 * This is the model class for table "general.requisito".
 *
 * The followings are the available columns in table 'general.requisito':
 * @property integer $id
...
class Requisito extends CActiveRecord
{
    ...
    public function rules()
    {
            ...
            return array(
                    ...
                    array('nombre, descripcion, fecha, eliminado', 'safe'),
    ...
    public function searchRequisito($nombre)
    {
        $criteria = new CDbCriteria;
    ...
    public function registrarRequisito($nombre)
    {
        $model = new Requisito();
        $model->nombre = $nombre;
        if($model->save())
