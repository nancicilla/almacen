<?php
/*
 * Controlcalidadproductoalmacen.php
 *
 * Version 0.$Rev: 244 $
 *
 * Creacion: 17/01/2019
 ...
 * @property string $cantidaddevolucionaceptada
 * @property string $observacion
 * @property string $fecha
 * @property string $usuario
 * @property boolean $eliminado
 */
class Controlcalidadproductoalmacen extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
            ...
            return array(
                    ...
                    array('cantidaddevolucion, cantidadbaja, cantidadaceptada, cantidaddevolucionaceptada', 'length', 'max'=>10),
                    array('usuario', 'length', 'max'=>30),
                    array('observacion, fecha, eliminado, cantidadregistrada, idrecuperacion', 'safe'),
                    // The following rule is used by search().
                    // @todo Please remove those attributes that should not be searched.
                    array('id, idcontrolcalidad, idproducto, cantidadregistrada, cantidaddevolucion, cantidadbaja, cantidadaceptada, cantidaddevolucionaceptada, observacion, fecha, usuario, eliminado', 'safe', 'on'=>'search'),
            );
    }
    ...
    public function search()
    {
		...
		$criteria->addSearchCondition('t.cantidaddevolucionaceptada',$this->cantidaddevolucionaceptada,true,'AND','ILIKE');
     ...
     * @return Controlcalidadproductoalmacen the static model class
     */
    ...
    public function obtenerProductos($idcontrolcalidad) {
        $criteria = new CDbCriteria;
