    ...
    public function search() {
        ...
        if ($this->validate()) {
            ...
            if($this->idproducto!=null){
                $criteria->addCondition("t.id in (select idpedido from documentoproducto where idproducto=".$this->idproducto." and idpedido=t.id and eliminado=false)");
            }
        } else {
...
//                ),
    ...
    public function getVerificarPedidoProductoFaltante() {
        ...
        $q="select * from documentoproducto where "
                . "idpedido=".$this->id." and gestionschemapedido='".System::getNameLastSchema()."' and eliminado=false and "
