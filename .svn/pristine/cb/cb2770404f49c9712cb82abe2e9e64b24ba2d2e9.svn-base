...
class PedidoespecialController extends Controller {
     ...
     * @return Pedidoespecial the loaded model
     ...
     * @param Pedidoespecial $model the model to be validated
     */
     ...
     */
    public function actionVerificarGenerarOrdenProduccion($id) {
