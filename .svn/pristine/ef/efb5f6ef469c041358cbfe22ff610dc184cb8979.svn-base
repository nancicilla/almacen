 ...
 */
class ProduccionOrdenestado extends CActiveRecord
{
    ...
    public function rules()
    {
            ...
            return array(
                    ...
                    array('descripcion, idorden, idestado, fecha, usuario, eliminado, idOrden', 'safe', 'on'=>'search'),
            );
    }
    ...
    public function beforeSave() {
		...
		if(isset(Yii::app()->session['varUsuario']))
            $this->usuario = Yii::app()->session['varUsuario'];
        else
